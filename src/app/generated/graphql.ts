...
export type OhmCirculatingSupplyQueryVariables = Exact<{ [key: string]: never }>;

export type OhmCirculatingSupplyQuery = {
  __typename?: "Query";
  protocolMetrics: Array<{ __typename?: "ProtocolMetric"; ohmCirculatingSupply?: string | null }>;
};

export const OhmCirculatingSupplyDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "OHMCirculatingSupply" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "protocolMetrics" },
            arguments: [
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "Field", name: { kind: "Name", value: "ohmCirculatingSupply" } }],
            },
          },
        ],
      },
...
} as unknown as DocumentNode<OhmCirculatingSupplyQuery, OhmCirculatingSupplyQueryVariables>;
